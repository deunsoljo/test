        ...
        <div class="jumbotron" style="background-color:white">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="com-md-1">
                        <button id="button" type="button" class="btn btn-default dropdown-toggle" style="padding-bottom: 12px; padding-top:12px">장소 입력</button>
                    </div>
                </div>
                ...
                <script>
                    ...
                    xhr_carwash.onreadystatechange = function () {
                        if (xhr_carwash.readyState == 4 && xhr_carwash.status == 200) {//xhr이 작동할 때 정보를 받아온 json을 출력
                            ...
                            console.log(carwash_list['weather']['wIndex']['carWash'][1]['locationName']);//쿼리중 지역 이름을 뽑아
